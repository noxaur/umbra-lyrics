...
import { handleYouTubeSearch, normalizeSearchLimit } from "../src/handlers/youtube-search"
...
vi.mock("../src/handlers/youtube-music-search", () => ({
  handleYouTubeMusicSearch: vi.fn(),
}))

import { searchViaInnertube } from "../src/lib/youtube-innertube"
import { handleYouTubeMusicSearch } from "../src/handlers/youtube-music-search"

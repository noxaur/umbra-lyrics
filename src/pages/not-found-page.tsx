...
import { ArrowRight, Home, Mic2, Sparkles } from "lucide-react"
...
export function NotFoundPage() {
  ...
  const suggestions = suggestRoutes(location.pathname, location.search)
      ...
      <section className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-4 py-16">
        ...
        <div className="relative z-10 w-full max-w-xl text-center">
          ...
          <motion.h1
            ...
            className="mt-3 bg-gradient-to-br from-foreground via-primary to-foreground bg-clip-text text-5xl font-bold tracking-tight text-transparent sm:text-6xl"
          >
            404
          </motion.h1>
          ...
          >
            This page never made it to the stage.
          </motion.p>
